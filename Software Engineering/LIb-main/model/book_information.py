...
class BookInfo(QGroupBox):
    ...
    def submitFunction(self):
        ...
        if len(self.book_msg['AUTHOR']) == 0:
            ...
            return
        if len(self.book_msg['PUBLICATION_DATE']) > 17:
        ...
        if self.book_msg["PUBLICATION_DATE"][4] != '-':
            ...
            return
        if self.book_msg["PUBLICATION_DATE"][7] != '-':
            self.errorBox('日期格式不对')
            return
        if self.book_msg["PUBLICATION_DATE"][10] != '-':
            self.errorBox('日期格式不对')
            return
        if self.book_msg["PUBLICATION_DATE"][13] != ':':
            self.errorBox('日期格式不对')
            return
        all_num = self.book_msg["PUBLICATION_DATE"][:4] + self.book_msg[
            "PUBLICATION_DATE"][5:7]+self.book_msg["PUBLICATION_DATE"][8:10]+self.book_msg["PUBLICATION_DATE"][11:13]+self.book_msg["PUBLICATION_DATE"][14:]
